package fear.client.utility.render.shaders;
...
import fear.client.utility.render.WindowResizeCallback;
import fear.client.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import fear.client.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import fear.client.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("fearclient", "blur"), VertexFormats.POSITION);
