...
import fear.client.core.hooks.ManagerShutdownHook;
import fear.client.core.hooks.ModuleShutdownHook;
...
public class FearClient implements ModInitializer {
    public static final ModMetadata MOD_META;

    public static final String MOD_ID = "fearclient";
    public static final String NAME = "Fear Client";
    ...
    public void onInitialize() {
        ...
        EVENT_BUS.registerLambdaFactory("fear.client",
        ...
        LOGGER.info("[Fear Client] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
    ...
    public enum KeyListening {
        FearGui, ClickGui, Search, Sliders, Strings, ThunderGui
    }
}
