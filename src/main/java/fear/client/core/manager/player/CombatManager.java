package fear.client.core.manager.player;
...
import fear.client.events.impl.EventPostTick;
import fear.client.events.impl.PacketEvent;
import fear.client.events.impl.TotemPopEvent;
import fear.client.features.modules.Module;
import fear.client.features.modules.combat.AntiBot;
    ...
    public void onPacketReceive(PacketEvent.Receive event) {
        ...
        if (event.getPacket() instanceof EntityStatusS2CPacket pac) {
            if (pac.getStatus() == EntityStatuses.USE_TOTEM_OF_UNDYING) {
                ...
                FearClient.EVENT_BUS.post(new TotemPopEvent((PlayerEntity) ent, popList.get(ent.getName().getString())));
            }
        }
    }
