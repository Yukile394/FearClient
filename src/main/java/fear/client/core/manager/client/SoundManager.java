...
import fear.client.features.modules.client.SoundFX;
import fear.client.features.modules.misc.ChatUtils;
...
import static fear.client.features.cmd.Command.sendMessage;
import static fear.client.core.manager.client.ConfigManager.SOUNDS_FOLDER;
import static fear.client.features.modules.client.ClientSettings.isRu;

public class SoundManager implements IManager {
    public final Identifier KEYPRESS_SOUND = Identifier.of("fearclient:keypress");
    public SoundEvent KEYPRESS_SOUNDEVENT = SoundEvent.of(KEYPRESS_SOUND);
    public final Identifier KEYRELEASE_SOUND = Identifier.of("fearclient:keyrelease");
    public SoundEvent KEYRELEASE_SOUNDEVENT = SoundEvent.of(KEYRELEASE_SOUND);
    public final Identifier UWU_SOUND = Identifier.of("fearclient:uwu");
    public SoundEvent UWU_SOUNDEVENT = SoundEvent.of(UWU_SOUND);
    public final Identifier ENABLE_SOUND = Identifier.of("fearclient:enable");
    public SoundEvent ENABLE_SOUNDEVENT = SoundEvent.of(ENABLE_SOUND);
    public final Identifier DISABLE_SOUND = Identifier.of("fearclient:disable");
    public SoundEvent DISABLE_SOUNDEVENT = SoundEvent.of(DISABLE_SOUND);
    public final Identifier MOAN1_SOUND = Identifier.of("fearclient:moan1");
    public SoundEvent MOAN1_SOUNDEVENT = SoundEvent.of(MOAN1_SOUND);
    public final Identifier MOAN2_SOUND = Identifier.of("fearclient:moan2");
    public SoundEvent MOAN2_SOUNDEVENT = SoundEvent.of(MOAN2_SOUND);
    public final Identifier MOAN3_SOUND = Identifier.of("fearclient:moan3");
    public SoundEvent MOAN3_SOUNDEVENT = SoundEvent.of(MOAN3_SOUND);
    public final Identifier MOAN4_SOUND = Identifier.of("fearclient:moan4");
    public SoundEvent MOAN4_SOUNDEVENT = SoundEvent.of(MOAN4_SOUND);
    public final Identifier SKEET_SOUND = Identifier.of("fearclient:skeet");
    public SoundEvent SKEET_SOUNDEVENT = SoundEvent.of(SKEET_SOUND);
    public final Identifier ORTHODOX_SOUND = Identifier.of("fearclient:orthodox");
    public SoundEvent ORTHODOX_SOUNDEVENT = SoundEvent.of(ORTHODOX_SOUND);
    public final Identifier BOOLEAN_SOUND = Identifier.of("fearclient:boolean");
    public SoundEvent BOOLEAN_SOUNDEVENT = SoundEvent.of(BOOLEAN_SOUND);
    public final Identifier SCROLL_SOUND = Identifier.of("fearclient:scroll");
    public SoundEvent SCROLL_SOUNDEVENT = SoundEvent.of(SCROLL_SOUND);
    public final Identifier SWIPEIN_SOUND = Identifier.of("fearclient:swipein");
    public SoundEvent SWIPEIN_SOUNDEVENT = SoundEvent.of(SWIPEIN_SOUND);
    public final Identifier SWIPEOUT_SOUND = Identifier.of("fearclient:swipeout");
    public SoundEvent SWIPEOUT_SOUNDEVENT = SoundEvent.of(SWIPEOUT_SOUND);
    public final Identifier ALERT_SOUND = Identifier.of("fearclient:alert");
    public SoundEvent ALERT_SOUNDEVENT = SoundEvent.of(ALERT_SOUND);
    public final Identifier PM_SOUND = Identifier.of("fearclient:pmsound");
    public SoundEvent PM_SOUNDEVENT = SoundEvent.of(PM_SOUND);
    public final Identifier RIFK_SOUND = Identifier.of("fearclient:rifk");
    public SoundEvent RIFK_SOUNDEVENT = SoundEvent.of(RIFK_SOUND);
    public final Identifier CUTIE_SOUND = Identifier.of("fearclient:cutie");
