...
import fear.client.features.hud.impl.*;
import fear.client.features.modules.Module;
import fear.client.features.modules.client.*;
import fear.client.features.modules.combat.*;
import fear.client.features.modules.misc.*;
import fear.client.features.modules.movement.Timer;
import fear.client.features.modules.movement.*;
import fear.client.features.modules.player.*;
import fear.client.features.modules.render.Particles;
import fear.client.features.modules.render.*;
...
public class ModuleManager implements IManager {
    ...
    public static FearClientGui thunderHackGui = new FearClientGui();
    ...
    public void onLoad(String category) {
        try {
            FearClient.EVENT_BUS.unsubscribe(unHook);
        ...
        modules.forEach(m -> {
            if (m.isEnabled() && (m.getCategory().getName().equalsIgnoreCase(category) || category.equals("none")))
                FearClient.EVENT_BUS.subscribe(m);
        });
    ...
    public void onRender2D(DrawContext context) {
        ...
        FearClient.core.onRender2D(context);
    }
    ...
    public void onUnload(String category) {
        modules.forEach(module -> {
            if (module.isEnabled() && (module.getCategory().getName().equalsIgnoreCase(category) || category.equals("none"))) {
                FearClient.EVENT_BUS.unsubscribe(module);
    ...
    public void registerModule(Module module) {
        ...
        if (module.isEnabled())
            FearClient.EVENT_BUS.subscribe(module);
    }
