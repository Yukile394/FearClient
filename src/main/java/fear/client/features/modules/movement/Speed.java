...
import fear.client.injection.accesors.IInteractionManager;
import fear.client.features.modules.Module;
import fear.client.setting.Setting;
import fear.client.utility.interfaces.IEntity;
...
import static fear.client.utility.player.MovementUtility.isMoving;
...
public class Speed extends Module {
    ...
    private fear.client.utility.Timer elytraDelay = new fear.client.utility.Timer();
    private fear.client.utility.Timer startDelay = new fear.client.utility.Timer();
    ...
    public void onSync(EventSync e) {
        ...
        if (mode.getValue() == Mode.MatrixJB) {
            ...
            if (MovementUtility.isMoving() && closeToGround && mc.player.fallDistance <= 0) {
                ...
                FearClient.TICK_TIMER = matrixJBSpeed.getValue();
    ...
    public void modifyVelocity(EventPlayerTravel e) {
        if (mode.getValue() == Mode.GrimEntity && !e.isPre() && FearClient.core.getSetBackTime() > 1000) {
        ...
        if ((mode.is(Mode.GrimEntity2) || mode.is(Mode.GrimCombo)) && !e.isPre() && FearClient.core.getSetBackTime() > 1000 && MovementUtility.isMoving()) {
            int collisions = 0;
    ...
    public void onMove(EventMove event) {
        ...
        if (MovementUtility.isMoving()) {
            FearClient.TICK_TIMER = useTimer.getValue() ? 1.088f : 1f;
