package fear.client.features.modules.movement;
...
import fear.client.features.modules.combat.Criticals;
...
import fear.client.utility.player.MovementUtility;
...
import static fear.client.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final fear.client.utility.Timer startTimer = new fear.client.utility.Timer();
    private final fear.client.utility.Timer redeployTimer = new fear.client.utility.Timer();
    private final fear.client.utility.Timer strictTimer = new fear.client.utility.Timer();
    private final fear.client.utility.Timer pingTimer = new fear.client.utility.Timer();
