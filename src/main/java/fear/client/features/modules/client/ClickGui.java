...
import fear.client.events.impl.EventSetting;
...
public class ClickGui extends Module {
    ...
    public void onEnable() {
        if(pauseBaritone.getValue() && !fullNullCheck() && FearClient.baritone){
    ...
    public enum Image {
        ...
        Image(String file, int fileWidth, int fileHeight, int[] pos, int size) {
            ...
            this.file = Identifier.of("fearclient", "textures/gui/images/" + file);
            this.pos = pos;
            this.size = size;
        }
    }
