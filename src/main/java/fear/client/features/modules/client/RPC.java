package fear.client.features.modules.client;
...
import fear.client.utility.discord.DiscordEventHandlers;
import fear.client.utility.discord.DiscordRPC;
import fear.client.utility.discord.DiscordRichPresence;
...
public final class RPC extends Module {
    ...
    public static void readFile() {
        try {
            File file = new File("FearClient/misc/RPC.txt");
            if (file.exists()) {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            presence.largeImageText = "v" + FearClient.VERSION + " [" + FearClient.GITHUB_HASH + "]";
            ...
            thread = new Thread(() -> {
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    switch (smode.getValue()) {
                        ...
                        case Version -> presence.state = "v" + FearClient.VERSION +" for mc 1.21";
                    }
                    ...
                    presence.button_url_1 = "https://github.com/Yukile394/FearClient/";
