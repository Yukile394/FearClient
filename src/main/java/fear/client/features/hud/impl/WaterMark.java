package fear.client.features.hud.impl;
...
import fear.client.utility.render.TextUtil;
...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.thglitch.drawString(context.getMatrices(), "FEAR CLIENT", getPosX() + 5.5, getPosY() + 5, -1);
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                float width = FontRenderers.sf_bold.getStringWidth("FearClient " + info) + 5;
                Render2DEngine.drawHudBase(context.getMatrices(), getPosX(), getPosY(), width, 10, 3);
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), ru.getValue() ? textUtil + " " : "FearClient ", getPosX() + 2, getPosY() + 2.5f, 10);
                FontRenderers.sf_bold.drawString(context.getMatrices(), info, getPosX() + 2 + FontRenderers.sf_bold.getStringWidth("FearClient "), getPosY() + 2.5f, HudEditor.textColor.getValue().getColor());
            ...
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "FearClient v" + FearClient.VERSION, getPosX() + 5.5f, getPosY() + 5, 10);
