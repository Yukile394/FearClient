...
import fear.client.features.modules.combat.AutoAnchor;
import fear.client.features.modules.combat.AutoCrystal;
...
import fear.client.utility.render.animation.EaseOutCirc;
...
public class TargetHud extends HudElement {
    ...
    private final Setting<ModeEn> Mode = new Setting<>("Mode", ModeEn.FearClient);
    ...
    public void onEnable() {
        try {
            ...
            sendMessage(".minecraft -> FearClientRecode -> misc -> images -> thud.png");
        }
    }
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (animation.getAnimationd() > 0) {
            ...
            switch (Mode.getValue()) {
                case FearClient -> renderFearClient(context, health, animationFactor);
    ...
    private void renderFearClient(DrawContext context, float health, float animationFactor) {
        float hurtPercent = target.hurtTime / 6f;
    ...
    public enum ModeEn {
        FearClient, NurikZapen, CelkaPasta
    }
}