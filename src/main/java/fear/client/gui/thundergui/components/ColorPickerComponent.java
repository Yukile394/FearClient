...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) FearClient.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(FearClient.copy_color == null ? getColorSetting().getColorObject() : FearClient.copy_color);
    }
