package fear.client.gui.clickui;
...
import fear.client.features.modules.client.BaritoneSettings;
import fear.client.features.modules.client.ClickGui;
import fear.client.features.modules.client.HudEditor;
import fear.client.gui.clickui.impl.SearchBar;
...
public class Category extends AbstractCategory {
    ...
    public Category(Module.Category category, ArrayList<Module> features, float x, float y, float width, float height) {
        ...
        ICON = Identifier.of("fearclient", "textures/gui/headers/" + (Module.Category.isCustomCategory(category) ? "stock" : category.getName().toLowerCase()) + ".png");

        if (category.getName().equals("Client"))
            buttons.add(new SearchBar());

        features.forEach(feature -> {
            if (!(feature instanceof BaritoneSettings) || FearClient.baritone)
