...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        boolean dark = Render2DEngine.isDark(FearClient.copy_color);
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, FearClient.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) FearClient.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(FearClient.copy_color.getRGB());
