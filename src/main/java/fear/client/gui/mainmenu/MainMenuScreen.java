package fear.client.gui.mainmenu;
...
public class MainMenuScreen extends Screen {
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.thglitchBig.drawCenteredString(context.getMatrices(), "FEAR CLIENT", (int) (halfOfWidth), (int) (halfOfHeight - 120), new Color(255, 255, 255, hoveredLogo ? 230 : 180).getRGB());
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (Render2DEngine.isHovered(mouseX, mouseY, (int) (halfOfWidth - 157), (int) (halfOfHeight - 140), 300, 70))
            Util.getOperatingSystem().open(URI.create("https://fearclient-site.vercel.app/"));
